%% Time_DirectLearningDnCNN.m
% 计算 DirectLearningDnCNN 模型在验证集上的平均推理时间
...
%% ====== 2. 加载训练好的 DirectLearningDnCNN 模型 ======
fprintf('正在加载 DirectLearningDnCNN 模型...\n');
load('DirectLearningDnCNN_model_20260210_204956.mat');  % 加载模型
fprintf('模型加载完成\n');
...
%% ====== 7. 保存结果 ======
save('DirectLearningDnCNN_inference_times.mat', 'all_times', ...
     'mean_time', 'std_time', 'min_time', 'max_time', 'median_time', 'num_tifs');
fprintf('\n结果已保存到 DirectLearningDnCNN_inference_times.mat\n');