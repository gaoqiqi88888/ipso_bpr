...
function [bestchrom, bestfitness, trace_best] = PSO_improved_p1(sizepop, maxgen, numsum, fobj, c1, c2, w_init, w_final, v_max, v_min, pos_max, pos_min, perturb_trigger_ratio, perturb_std, p)
